...
if role == "Employee":
        ...
        if response.status_code == 200:
            ...
            if jobs:
                ...
                df = df.rename(columns={
                    "postId": "Job ID",
                    "postProfile": "Job Role",
                    "postDesc": "Description",
                    "reqExperience": "Experience Required",
                    "postTechStack": "Tech Stack"
                })
                st.dataframe(df)
            else:
    ...
    with tab1:
        ...
        employer_id = st.number_input("Employer_ID",min_value=1,step=1)
        ...
        if st.button("Add Job"):
            job_data = {
                ...
                "postTechStack": post_tech_stack.split(",")
